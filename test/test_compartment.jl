...
digits = 6
@test round.(compartment_signals(axon, prot), digits=digits) ==
    round.(
    [
        0.830306256448048,
        0.660977107327415,
...
@test round.(compartment_signals(extra, prot), digits=digits) ==
    round.(
    [
        0.672953994843349,
        0.376716014811867,
        ...
        6.163836418812522e-07,
    ],
    digits=digits,
)

@test round.(compartment_signals(iso, prot), digits=digits) ==
    round.(
    [
        0.135335283236613,
        0.006737946999085,
        ...
        4.473779306181057e-38,
    ],
    digits=digits,
)

@test round.(compartment_signals(sphere, prot), digits=digits) ==
    round.(
    [
        0.926383765355293,
        0.825994848716073,
